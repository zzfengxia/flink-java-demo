...
public class RedisCommandDescription implements Serializable {
    ...
    public RedisCommandDescription(RedisCommand redisCommand, Integer ttl, String keyColumn, String fieldColumn,
                                   String valueColumn, boolean putIfAbsent, String additionalKey,
                                   Integer cacheMaxRows, Integer cacheTtlSec)  {
